...
object Dependencies {
  ...
  val akkaActor     = "com.typesafe.akka"                       %%  "akka-osgi"                   % "2.3.0-RC4"
  val akkaSlf4j     = "com.typesafe.akka"                       %%  "akka-slf4j"                  % "2.3.0-RC4"
  val akkaTestKit   = "com.typesafe.akka"                       %%  "akka-testkit"                % "2.3.0-RC4"
