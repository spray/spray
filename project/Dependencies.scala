...
object Dependencies {
  ...
  val akkaActor     = "com.typesafe.akka"                       %%  "akka-actor"                  % "2.2.0-RC2"
  val akkaSlf4j     = "com.typesafe.akka"                       %%  "akka-slf4j"                  % "2.2.0-RC2"
  val akkaTestKit   = "com.typesafe.akka"                       %%  "akka-testkit"                % "2.2.0-RC2"
