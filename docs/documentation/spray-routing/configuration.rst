...
Just like Akka *spray-routing* relies on the `typesafe config`_ library for configuration. As such its JAR contains a
...
.. literalinclude:: /../spray-routing/src/main/resources/reference.conf
   :language: bash