...
object PathMatcher extends ImplicitPathMatcherConstruction {
  ...
  implicit def PathMatcher1Ops[T](matcher: PathMatcher1[T]): PathMatcher1Ops[T] = new PathMatcher1Ops[T](matcher)
  class PathMatcher1Ops[T](matcher: PathMatcher1[T]) {
  ...
  implicit def PimpedPathMatcher[L <: HList](pm: PathMatcher[L]): PimpedPathMatcher[L] = new PimpedPathMatcher(pm)
  class PimpedPathMatcher[L <: HList](underlying: PathMatcher[L]) {
