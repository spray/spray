...
sealed trait PipelineStage {
  ...
  def build(context: ActorContext, commandPL: CPL, eventPL: EPL): BuildResult

  def buildPipelines(context: ActorContext, commandPL: CPL, eventPL: EPL): Pipelines
